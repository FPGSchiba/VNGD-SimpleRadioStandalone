...
namespace Ciribob.DCS.SimpleRadio.Standalone.Overlay
{
    ...
    /// </summary>
    public partial class RadioOverlayWindowFiveHorizontal : Window
    {
        ...
        {
            _globalSettings.SetPositionSetting(GlobalSettingsKeys.RadioFiveHorizontalX, Left);
            _globalSettings.SetPositionSetting(GlobalSettingsKeys.RadioFiveHorizontalY, Top);
            _globalSettings.SetPositionSetting(GlobalSettingsKeys.RadioFiveHorizontalWidth, Width);
            _globalSettings.SetPositionSetting(GlobalSettingsKeys.RadioFiveHorizontalHeight, Height);
            _globalSettings.SetPositionSetting(GlobalSettingsKeys.RadioFiveHorizontalOpacity, Opacity);
...
//
        ...
        {
            var mainWindow = o as RadioOverlayWindowFiveHorizontal;
            if (mainWindow != null)
