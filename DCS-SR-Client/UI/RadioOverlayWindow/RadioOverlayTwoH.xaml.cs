...
namespace Ciribob.DCS.SimpleRadio.Standalone.Overlay
{
    ...
    /// </summary>
    public partial class RadioOverlayWindowTwoH : Window
    {
        ...
        public RadioOverlayWindowTwoH()
        {
            ...
            Opacity = _globalSettings.GetPositionSetting(GlobalSettingsKeys.RadioTwoHOpacity).DoubleValue;
            ...
            Left = _globalSettings.GetPositionSetting(GlobalSettingsKeys.RadioTwoHX).DoubleValue;
            Top = _globalSettings.GetPositionSetting(GlobalSettingsKeys.RadioTwoHY).DoubleValue;

            Width = _globalSettings.GetPositionSetting(GlobalSettingsKeys.RadioTwoHWidth).DoubleValue;
            Height = _globalSettings.GetPositionSetting(GlobalSettingsKeys.RadioTwoHHeight).DoubleValue;
        ...
        private void RadioRefresh(object sender, EventArgs eventArgs)
        {
            ...
            if ((dcsPlayerRadioInfo != null) && dcsPlayerRadioInfo.IsCurrent())
            {
                ...
                if (availableRadios > 1)
                {
                    ...
                    {
                        ControlText.Text = "Two Radio Panel Horizontal";
                    }
                    else
                    {
                        ControlText.Text = "Two Radio Panel Horizontal";
        ...
        {
            _globalSettings.SetPositionSetting(GlobalSettingsKeys.RadioTwoHWidth, Width);
            _globalSettings.SetPositionSetting(GlobalSettingsKeys.RadioTwoHHeight,Height);
            _globalSettings.SetPositionSetting(GlobalSettingsKeys.RadioTwoHOpacity,Opacity);
            _globalSettings.SetPositionSetting(GlobalSettingsKeys.RadioTwoHX,Left);
            _globalSettings.SetPositionSetting(GlobalSettingsKeys.RadioTwoHY, Top);
            base.OnClosing(e);
        ...
        public static readonly DependencyProperty ScaleValueProperty = DependencyProperty.Register("ScaleValue",
            typeof(double), typeof(RadioOverlayWindowTwoH),
            new UIPropertyMetadata(1.0, OnScaleValueChanged,
                OnCoerceScaleValue));

        private static object OnCoerceScaleValue(DependencyObject o, object value)
        {
            var mainWindow = o as RadioOverlayWindowTwoH;
            if (mainWindow != null)
