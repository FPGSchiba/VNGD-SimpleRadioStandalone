...
namespace Ciribob.DCS.SimpleRadio.Standalone.Overlay
{
    ...
    /// </summary>
    public partial class RadioOverlayWindowFiveV : Window
    {
        ...
        public RadioOverlayWindowFiveV()
        {
            ...
            Opacity = _globalSettings.GetPositionSetting(GlobalSettingsKeys.RadioFiveVOpacity).DoubleValue;
            ...
            Left = _globalSettings.GetPositionSetting(GlobalSettingsKeys.RadioFiveVX).DoubleValue;
            Top = _globalSettings.GetPositionSetting(GlobalSettingsKeys.RadioFiveVY).DoubleValue;

            Width = _globalSettings.GetPositionSetting(GlobalSettingsKeys.RadioFiveVWidth).DoubleValue;
            Height = _globalSettings.GetPositionSetting(GlobalSettingsKeys.RadioFiveVHeight).DoubleValue;
        ...
        private void RadioRefresh(object sender, EventArgs eventArgs)
        {
            ...
            if ((dcsPlayerRadioInfo != null) && dcsPlayerRadioInfo.IsCurrent())
            {
                ...
                if (availableRadios > 1)
                {
                    ...
                    {
                        ControlText.Text = "Five Radio Panel Vertical";
                    }
                    else
                    {
                        ControlText.Text = "Five Radio Panel Vertical";
                ...
                {
                    ControlText.Text = "Five Radio Panel Vertical (Disconnected)";
        ...
        {
            _globalSettings.SetPositionSetting(GlobalSettingsKeys.RadioFiveVWidth, Width);
            _globalSettings.SetPositionSetting(GlobalSettingsKeys.RadioFiveVHeight, Height);
            _globalSettings.SetPositionSetting(GlobalSettingsKeys.RadioFiveVOpacity, Opacity);
            _globalSettings.SetPositionSetting(GlobalSettingsKeys.RadioFiveVX, Left);
            _globalSettings.SetPositionSetting(GlobalSettingsKeys.RadioFiveVY, Top);
            base.OnClosing(e);
        ...
        public static readonly DependencyProperty ScaleValueProperty = DependencyProperty.Register("ScaleValue",
            typeof(double), typeof(RadioOverlayWindowFiveV),
            new UIPropertyMetadata(1.0, OnScaleValueChanged,
                OnCoerceScaleValue));

        private static object OnCoerceScaleValue(DependencyObject o, object value)
        {
            var mainWindow = o as RadioOverlayWindowFiveV;
            if (mainWindow != null)
