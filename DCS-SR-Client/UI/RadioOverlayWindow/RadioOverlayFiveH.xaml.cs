...
namespace Ciribob.DCS.SimpleRadio.Standalone.Overlay
{
    ...
    /// </summary>
    public partial class RadioOverlayWindowFiveH : Window
    {
        ...
        public RadioOverlayWindowFiveH()
        {
            ...
            Opacity = _globalSettings.GetPositionSetting(GlobalSettingsKeys.RadioFiveHOpacity).DoubleValue;
            ...
            Left = _globalSettings.GetPositionSetting(GlobalSettingsKeys.RadioFiveHX).DoubleValue;
            Top = _globalSettings.GetPositionSetting(GlobalSettingsKeys.RadioFiveHY).DoubleValue;

            Width = _globalSettings.GetPositionSetting(GlobalSettingsKeys.RadioFiveHWidth).DoubleValue;
            Height = _globalSettings.GetPositionSetting(GlobalSettingsKeys.RadioFiveHHeight).DoubleValue;
        ...
        {
            _globalSettings.SetPositionSetting(GlobalSettingsKeys.RadioFiveHWidth, Width);
            _globalSettings.SetPositionSetting(GlobalSettingsKeys.RadioFiveHHeight, Height);
            _globalSettings.SetPositionSetting(GlobalSettingsKeys.RadioFiveHOpacity, Opacity);
            _globalSettings.SetPositionSetting(GlobalSettingsKeys.RadioFiveHX, Left);
            _globalSettings.SetPositionSetting(GlobalSettingsKeys.RadioFiveHY, Top);
            base.OnClosing(e);
        ...
        public static readonly DependencyProperty ScaleValueProperty = DependencyProperty.Register("ScaleValue",
            typeof(double), typeof(RadioOverlayWindowFiveH),
            new UIPropertyMetadata(1.0, OnScaleValueChanged,
                OnCoerceScaleValue));

        private static object OnCoerceScaleValue(DependencyObject o, object value)
        {
            var mainWindow = o as RadioOverlayWindowFiveH;
            if (mainWindow != null)
