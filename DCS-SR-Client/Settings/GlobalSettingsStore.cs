...
namespace Ciribob.DCS.SimpleRadio.Standalone.Client.Settings
{
    ...
    public class GlobalSettingsStore
    {
        ...
        private readonly Dictionary<string, string> defaultGlobalSettings = new Dictionary<string, string>()
        {
            ...
            {GlobalSettingsKeys.RadioTwoVX.ToString(), "300"},
            {GlobalSettingsKeys.RadioTwoVY.ToString(), "300"},
            {GlobalSettingsKeys.RadioTwoVSize.ToString(), "1.0"},
            {GlobalSettingsKeys.RadioTwoVOpacity.ToString(), "1.0"},

            {GlobalSettingsKeys.RadioTwoVWidth.ToString(), "170"},
            {GlobalSettingsKeys.RadioTwoVHeight.ToString(), "250"},

            {GlobalSettingsKeys.RadioTwoHX.ToString(), "300"},
            {GlobalSettingsKeys.RadioTwoHY.ToString(), "300"},
            {GlobalSettingsKeys.RadioTwoHSize.ToString(), "1.0"},
            {GlobalSettingsKeys.RadioTwoHOpacity.ToString(), "1.0"},

            {GlobalSettingsKeys.RadioTwoHWidth.ToString(), "335"},
            {GlobalSettingsKeys.RadioTwoHHeight.ToString(), "165"},

            {GlobalSettingsKeys.RadioThreeVX.ToString(), "300"},
            {GlobalSettingsKeys.RadioThreeVY.ToString(), "300"},
            {GlobalSettingsKeys.RadioThreeVSize.ToString(), "1.0"},
            {GlobalSettingsKeys.RadioThreeVOpacity.ToString(), "1.0"},

            {GlobalSettingsKeys.RadioThreeVWidth.ToString(), "170"},
            {GlobalSettingsKeys.RadioThreeVHeight.ToString(), "340"},

            {GlobalSettingsKeys.RadioThreeHX.ToString(), "300"},
            {GlobalSettingsKeys.RadioThreeHY.ToString(), "300"},
            {GlobalSettingsKeys.RadioThreeHSize.ToString(), "1.0"},
            {GlobalSettingsKeys.RadioThreeHOpacity.ToString(), "1.0"},

            {GlobalSettingsKeys.RadioThreeHWidth.ToString(), "495"},
            {GlobalSettingsKeys.RadioThreeHHeight.ToString(), "165"},

            {GlobalSettingsKeys.RadioFiveVX.ToString(), "300"},
            {GlobalSettingsKeys.RadioFiveVY.ToString(), "300"},
            {GlobalSettingsKeys.RadioFiveVSize.ToString(), "1.0"},
            {GlobalSettingsKeys.RadioFiveVOpacity.ToString(), "1.0"},

            {GlobalSettingsKeys.RadioFiveVWidth.ToString(), "170"},
            {GlobalSettingsKeys.RadioFiveVHeight.ToString(), "325"},

            {GlobalSettingsKeys.RadioFiveHX.ToString(), "300"},
            {GlobalSettingsKeys.RadioFiveHY.ToString(), "300"},
            {GlobalSettingsKeys.RadioFiveHSize.ToString(), "1.0"},
            {GlobalSettingsKeys.RadioFiveHOpacity.ToString(), "1.0"},

            {GlobalSettingsKeys.ClientX.ToString(), "200"},
            {GlobalSettingsKeys.ClientY.ToString(), "200"},

            {GlobalSettingsKeys.RadioTenHX.ToString(), "300"},
            {GlobalSettingsKeys.RadioTenHY.ToString(), "300"},

            {GlobalSettingsKeys.RadioTenVX.ToString(), "300"},
            {GlobalSettingsKeys.RadioTenVY.ToString(), "300"},
