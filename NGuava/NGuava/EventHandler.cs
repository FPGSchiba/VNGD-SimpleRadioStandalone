...
namespace NGuava
{
    ...
    ///     The MethodInfo is a flyweight object similar to String each MethodInfo on a class is uniqueuely formed with the
    ///     same hashcode.
    /// </summary>
    public class EventHandler
    {
        ...
        ///     target (specially if they are the same type)definetly we have two different event handler because the
        ///     subscriber(target)
        ///     has a state.
        ...
        /// <returns>
        ///     If the instances of target and method are the same as obj and obj is EventHandler
        /// </returns>
        public override bool Equals(object obj)
        {
            if (obj is EventHandler)
            {
                var that = (EventHandler) obj;
